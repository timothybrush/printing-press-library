...
but do not stop the import.`,
  ...
  ufo-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ufo-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ufo-goat-pp-cli import <resource> --input -`,
